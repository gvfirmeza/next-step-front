  ...
  export default function App() {
    ...
    return (
      <>
        ...
        {/* container da página */}
        <div className="min-h-screen bg-[#121214] pt-16 relative overflow-hidden">

          {/* gradiente superior tipo lâmpada */}
          <div className="absolute -top-5 left-0 w-full h-[500px] bg-[radial-gradient(ellipse_at_top,_#671B31_0%,_#1a1116_40%,_#121214_75%,_#121214_100%)] blur-sm pointer-events-none z-0" />

          {/* conteúdo principal acima do gradiente */}
